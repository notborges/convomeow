...
CREATE INDEX messages_account_recent ON messages(account_id, ingested_at DESC, public_id DESC);
CREATE INDEX messages_conversation_recent ON messages(conversation_id, ingested_at DESC, public_id DESC);
